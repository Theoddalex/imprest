"""Demo: a LangChain agent whose payments are gated by the agentpay MCP server.
...
async def main() -> None:
    # The developer's ONLY integration step: point at the agentpay server.
    ...
    print("tools from agentpay server:", [t.name for t in tools], "\n")
